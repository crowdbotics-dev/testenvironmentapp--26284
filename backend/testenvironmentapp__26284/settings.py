"""
Django settings for testenvironmentapp__26284 project.
...
ROOT_URLCONF = 'testenvironmentapp__26284.urls'
...
WSGI_APPLICATION = 'testenvironmentapp__26284.wsgi.application'
